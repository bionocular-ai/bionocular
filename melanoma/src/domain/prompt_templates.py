...
FAMILY_PROMPTS: dict[AttributeFamily, str] = {
    AttributeFamily.IDENTIFICATION: (
        ...
        "- cancer_type — drawn from: Cutaneous Melanoma | Cutaneous Melanoma with Brain/CNS "
        "Metastasis | Uveal Melanoma | Acral Melanoma | Mucosal Melanoma | "
        "Cutaneous Squamous Cell Carcinoma | Basal Cell Carcinoma | Merkel Cell Carcinoma. "
        "This field is MULTI-VALUED: when the cohort spans several of these, list every one it "
        "contains, comma-separated ('Acral Melanoma, Mucosal Melanoma'). Do not pick a single "
        "dominant type and do not collapse the list. Types outside the eight above are out of "
        "scope and are simply left out - a cohort of Merkel cell carcinoma, basal cell carcinoma "
        "and angiosarcoma is 'Merkel Cell Carcinoma, Basal Cell Carcinoma'. "
        "Default to Cutaneous Melanoma for unspecified/general melanoma.\n"
