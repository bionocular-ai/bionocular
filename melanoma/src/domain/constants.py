...
TREATMENT_ARM_SEPARATION_OPERATION: Final[str] = "treatment_arm_separation"
...
ATTRIBUTE_OUTPUT_ORDER: Final[tuple[str, ...]] = (
    ...
    "ae_leading_to_death",
    "ae_leading_to_dose_reduction",
    "ae_leading_to_dose_interruption",
    "ae_requiring_hospitalization",
    ...
    "serious_teae",
    "teae_immune_related",
    "teae_leading_to_dose_reduction",
    "teae_leading_to_dose_interruption",
    ...
    "trae_immune_related",
    "serious_trae",
    "trae_leading_to_dose_reduction",
    "trae_leading_to_dose_interruption",
    ...
    "grade_3_plus_ae_irr",
    "grade_3_plus_ae_fatigue",
    "grade_3_plus_ae_hypothyroidism",
    "grade_3_plus_ae_hyperthyroidism",
    "grade_3_plus_ae_ast_increased",
    "grade_3_plus_ae_vomiting",
    ...
    "grade_3_plus_trae_irr",
    "grade_3_plus_trae_fatigue",
    "grade_3_plus_trae_hypothyroidism",
    "grade_3_plus_trae_hyperthyroidism",
    "grade_3_plus_trae_ast_increased",
    "grade_3_plus_trae_vomiting",
    ...
    "grade_3_plus_teae_irr",
    "grade_3_plus_teae_fatigue",
    "grade_3_plus_teae_hypothyroidism",
    "grade_3_plus_teae_hyperthyroidism",
    "grade_3_plus_teae_ast_increased",
    "grade_3_plus_teae_vomiting",
)
