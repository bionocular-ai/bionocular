...
class TestMarkerPDFProcessor:
    ...
    async def test_validate_pdf_success(self):
        ...
        with patch('src.infrastructure.marker_processor.PdfConverter') as mock_converter:
            ...
            # Mock ConfigParser
            with patch('src.infrastructure.marker_processor.ConfigParser') as mock_config_parser:
    ...
    async def test_extract_text(self):
        ...
        with patch('src.infrastructure.marker_processor.PdfConverter') as mock_converter:
            ...
            with patch('src.infrastructure.marker_processor.text_from_rendered') as mock_text:
