...
import type { TrialRow, FieldEvalRow } from '@/lib/types'
...
const trials: TrialRow[] = [
  { nct: 'NCT01', decision: 'hitl', score: 0.5, isValid: true, failCount: 1, missedCount: 1, detViolationCount: 0, cancerType: [], fields: [] },
  { nct: 'NCT02', decision: 'kept', score: 1.0, isValid: true, failCount: 0, missedCount: 0, detViolationCount: 0, cancerType: [], fields: [] },
]
...
describe('Dashboard', () => {
  it('renders stat tiles without throwing', () => {
    render(<Dashboard trials={trials} fieldEvals={fieldEvals} metadata={{}} />)
  ...
  it('renders empty-state copy when there is no data to chart', () => {
    render(<Dashboard trials={[]} fieldEvals={[]} metadata={{}} />)
